...
export const ADD_LIST_IMAGES = 'create_list_images'
export const DELETE_IMAGES = 'delete_image'
export const DELETE_ALL_CAPTURE_IMAGES = 'delete_all_capture_images'
...
export const addInvoiceImages = (imagePath) => (dispatch) => {
    dispatch({
      type: ADD_LIST_IMAGES,
      payload: imagePath
    })
}

export const deleteInvoiceImage = (index) => (dispatch) => {
  dispatch({
    type: DELETE_IMAGES,
    payload: index
  })
...
export const deleteAllInvoiceImage = () => (dispatch) => {
  dispatch({
    type: DELETE_ALL_CAPTURE_IMAGES,
  })
}
...
export const uploadFile = async (invoice, dispatch) => {
  ...
  const typeCheck = invoice.image.split('.').pop().toLowerCase();
  let fileType = 'image/jpeg';
  if (typeCheck === 'pdf') {
    fileType = 'application/pdf';
  } else if (typeCheck === 'png') {
    fileType = 'image/png';
  }
