...
import UploadInvoiceImagesReducer from './uploads/UploadInvoiceImagesReducer';
...
import ReimbursementReducer from './reimbursements/AllReimbursementsReducer';
import ReimbursementDetailReducer from './reimbursements/ReimbursementDetailReducer';
import ReimbursementSummaryReducer from './reimbursements/ReimbursementSummaryReducer';
import AddReimbursementReducer from './reimbursements/AddReimbursementReducer';
import ReimbursementUploadReducer from './reimbursements/ReimbursementUploadReducer';
import TransactionFilterReducer from './transactions/TransactionFilterReducer';
...
export default combineReducers({
  ...
  uploadImagePdf: UploadInvoiceImagesReducer,
  ...
  allReimbursements: ReimbursementReducer,
  reimbursementDetail: ReimbursementDetailReducer,
  reimbursementSummary: ReimbursementSummaryReducer,
  addReimbursement: AddReimbursementReducer,
  reimbursementUpload: ReimbursementUploadReducer,
