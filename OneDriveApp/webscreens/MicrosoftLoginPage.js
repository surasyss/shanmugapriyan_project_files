...
export default class MicrosoftLoginPage extends Component<Props> {
...
// ------------------- function 4 ----------------------------- get onedrive files
  ...
  async one_drive_files(){
    ...
    if (this.state.onedrive_all_files){
      ...
      this.props.navigation.navigate('OneDriveItemsList', this.state.onedrive_all_files);
    }
...
// ------------------- function 5 ----------------------------- render
  ...
  render() {
    return <View style = {styles.container} >
              {this.state.isPasswordVisible ? this.before_login() : this.loding_screen()}
            </View>;
  }
}
