import {
  LOAD_PURCHASED_ITEM_DETAILS, LOAD_PURCHASED_ITEM_DETAILS_FAIL, LOAD_PURCHASED_ITEM_DETAILS_SUCCESS,
  LOAD_STARRED_PURCHASED_ITEMS,
  LOAD_STARRED_PURCHASED_ITEMS_FAIL,
  LOAD_STARRED_PURCHASED_ITEMS_SUCCESS, LOGOUT, MARK_ITEM_STAR_LOCAL, RESET_STARRED_PURCHASED_ITEMS
} from '../../actions';
...
export default (state = INITIAL_STATE, action) => {
  ...
  switch (type) {
    case LOAD_STARRED_PURCHASED_ITEMS:
      return { ...state, loading: true, firstLoad: payload.firstLoad };
    case LOAD_STARRED_PURCHASED_ITEMS_SUCCESS:
    ...
    case LOAD_STARRED_PURCHASED_ITEMS_FAIL:
      return {
        ...state, loading: false, error: payload.error, firstLoad: false
      };
    case RESET_STARRED_PURCHASED_ITEMS:
      return { ...state, data: [] };
