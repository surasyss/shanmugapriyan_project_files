...
import {
  Dimensions, StyleSheet, View, ScrollView, TouchableWithoutFeedback, Text
} from 'react-native';
...
export default class Items extends Component {
  ...
  render() {
    const {
      items, positionX, positionY, show, onPress, width, height, children, customScrollViewComp, autoHeightItemsList
    } = this.props;
    ...
    const ScrollViewComp = customScrollViewComp || ScrollView;
    return (
