import {
  ...
  LOAD_ALL_INVOICES,
  LOAD_ALL_INVOICES_FAIL,
  LOAD_ALL_INVOICES_SUCCESS, LOAD_INVOICE_DETAILS_SUCCESS, LOAD_INVOICE_GL_SPLITS_SUCCESS, LOAD_INVOICE_IMAGES_SUCCESS,
  LOAD_INVOICE_LINE_ITEMS_SUCCESS, LOGOUT, RESET_ALL_INVOICES, RESOLVE_INVOICE_FLAG_SUCCESS
} from '../../actions';
...
export default (state = INITIAL_STATE, action) => {
  ...
  switch (type) {
    ...
    case LOAD_ALL_INVOICES_SUCCESS:
