...
import Autocomplete from '../../qubiqle/AutoComplete';
import styles from './styles';
import Colors from '../../../styles/Colors';
import Button from '../../qubiqle/Button';
import DateRangePicker from '../../qubiqle/DateRangePicker';
import { formatDateRange, getDateRange } from '../../../utils/DateFormatter';
import Images from '../../../styles/Images';
import { loadVendors } from '../../../actions';

class PurchasedItemsFilter extends React.Component {
  constructor(props) {
    super(props);
    const {
      date_type, date_range, vendor
    } = props.filters;
    ...
    this.state = {
      date_types: [
        ...
        { key: 'last_7_days', name: 'Past 7 Days' },
        { key: 'this_month', name: 'This Month' },
        { key: 'last_30_days', name: 'Past 30 Days' },
        { key: 'last_3_months', name: 'Past 3 Months' },
        { key: 'last_1_year', name: 'Last 1 Year' },
        { key: 'custom', name: 'Custom Date' },
  ...
  clear() {
    this.setState({
      date_type: { key: 'anytime', name: 'Anytime' },
      date_range: getDateRange(null),
      vendor: null,
      vendor_query: ''
    });
  }
  ...
  renderForm() {
    const {
      date_types, date_type, date_range, isDatePickerShowing, vendor_query
    } = this.state;
      ...
      return (
        <View style={styles.formContainer}>
          ...
          <ModalDropdown
            ...
            onSelect={(idx, value) => {
              this.setState({ date_type: value, date_range: getDateRange(value.key) });
            }}
            onDropdownWillShow={() => {
          ...
          >
            <View style={styles.dropDownButton}>
              <Text style={styles.dropDownText}>{date_type ? date_type.name : ''}</Text>
              <Image
                resizeMode="contain"
      ...
      return (
        <DateRangePicker
          ...
          onSuccess={(start, end) => this.setState({
            ...
            date_type: { key: 'custom', name: 'Custom Date' }
          })}
          theme={{
