...
import {
  Dimensions, StyleSheet, View, TouchableWithoutFeedback
} from 'react-native';
...
export default class Select extends Component {
  constructor(props) {
    ...
    const defaultValue = props.defaultValue || this.getDefaultValue();
  ...
  _onPress() {
    const {
      optionListRef, children, onSelect, width, height, optionListExtraWidth, optionListLeftOffset, optionListTopOffset, optionListProps
    } = this.props;
  ...
  render() {
    const {
      width, height, children, defaultValue, style, styleOption, styleText, placeholder
    } = this.props;
