...
class SearchSingleFile extends Component {
    ...
    cancel_click = () =>{ console.log(" - --- cancel -------"), this.setState({ imageDisplay : false})}
    ...
    //             <TouchableOpacity style={styles.submitBotton} onPress={() => this.each_folder_access(accessKey) }>
    ...
    render() {
        ...
        return (
                <View style={{ height: 56}} >
                    ...
                    />
                    {this.state.imageDisplay ? this.fileView() : <View></View>}
                </View>
            );
    }
